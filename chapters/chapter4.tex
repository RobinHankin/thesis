...
\mycite{yoon2011} reports that students overwhelmingly defend the
...
\item[I will \metaphor{give you} this formula in a different form]
  ...
  this series of st
  atistics lectures (e.g., \dquote{I can
...
\item[The factorial function isn't easy \metaphor{to deal
  ...
  the factorial function is given agency.  \mycite{low2008} asserts that
