...
\epigraph{Metaphors, and their frequency of use, may serve as
  ...
  of a course of action are made explicit}{\mycite{miller1990}}
\end{singlespace}
...
The notion that a course \metaphor{provides} anything is a clear
example of the conduit metaphor, \conmet{communication is
...
\epigraph{Metaphors are important both as indicators of the ways we
  ...
  worldviews}{\mycite{paechter2004}}
\end{singlespace}
