...
\citeauthor{crawley2015} is one of many introductions to inferential
...
\mycite{lakoff2000}) asserts directly that the \bmi is unavoidable in
...
\mycite{pimm1984} asserts that textbooks' use of \emph{we}
...
chosen for detailed analysis of metaphorical language using the
\citeauthor{pragglejaz2007} procedure.

Metaphor was rare in all three textbooks, with the exception of the
basic metaphor of infinity, and the mathematicians' \dquote{we}, which
is not specific to statistics.
