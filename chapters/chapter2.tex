...
literature review of research has been carried out in this area, and
...
\begin{quote}
  \dquote{But the insidious effect of the foundation metaphor does not
    ...
    way to foresee the the eventual structure of knowledge, are
...
footing---has its roots in pure mathematics, and I consider metaphor
usage in mathematics in Chapters~\ref{chapter4} and~\ref{chapter5}.
...
foundations includes much debate and controversy.  \mycite{robins2000}
\end{quote}
\end{singlespace}
...
\citeauthor{sfard1998} considers these issues and, using the central
...
important and influential: \dquote{Different metaphors lead to
  different ways of thinking and to different activities}.
...
\metaphor{level} metaphor, for example, normalizes the notion that
